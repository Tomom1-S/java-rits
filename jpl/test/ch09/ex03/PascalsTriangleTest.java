...
//
//    @Test
//    public void 不適切な引数が指定された場合に例外を出す() {
//        String expectMsg = "第1引数には正の整数値を指定してください。";
//
//        Exception e = assertThrows(IllegalArgumentException.class, () -> PascalsTriangle.main(new String[]{"foo"}));
